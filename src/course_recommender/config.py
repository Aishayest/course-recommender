...
# "fit" — близость курса к тому, что студенту уже заходило. Вес намеренно
# небольшой: в отличие от нужности и шанса, проверить этот слой нечем, пока
# не видно, что студенты выбирают на самом деле.
UTILITY_WEIGHTS = {"need": 0.6, "access": 0.4, "fit": 0.2, "ease": 0.0}
